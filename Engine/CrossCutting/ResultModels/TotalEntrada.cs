...
namespace CrossCutting.ResultModels
{
    ...
    public partial class TotalEntrada
    {
        ...
        /// Resultado da somatória dos campos E16 [VL_BC_ICMS_ST],
        /// menos a somatória dos campos E15d[VL_BC_ICMS_ST],
        /// dividido pelo campo D02[QTD_TOT_ENTRADA]
        /// </summary>
        [Required]
        [RegularExpression(@"^(0|-?\d{0,9}(\.\d{0,2})?)$")]
        ...
        /// Somatória dos campos E17[VL_ICMS_SUPORT_ENTR],
        /// menos a somatória dos campos E16d[VL_ICMS_SUPORT_ENTR]
        /// </summary>
        [Required]
        [RegularExpression(@"^(0|-?\d{0,9}(\.\d{0,2})?)$")]
        ...
        /// É o resultado da divisão do campo D05[VL_TOT_ICMS_SUPORT_ENTR]
        /// pelo campo D02[QTD_TOT_ENTRADA]
        /// </summary>
        [Required]
        [RegularExpression(@"^(0|-?\d{0,9}(\.\d{0,2})?)$")]
